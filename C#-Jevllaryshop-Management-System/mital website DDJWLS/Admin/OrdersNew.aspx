<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="OrdersNew.aspx.cs" Inherits="Admin_OrdersNew" Title="DD Jewellers | Administarator Panel | Orders" %>
...
<table border="0" cellspacing="0" cellpadding="2" width="100%">
<tr align="center">
<td style="height: 17px"><span class="MenuTabTitle">&nbsp;New&nbsp;Orders&nbsp;</span></td>
</tr>
</table>
</td>
...
Orders</span>
 ...
 <td>
     <asp:Button ID="btnUnSelectAll" runat="server" Text="Unselect All" OnClick="btnUnSelectAll_Click" />
 </td>
 <td>
     <asp:Button ID="btnProcess" runat="server" Text="Process Selected Order" OnClick="btnProcess_Click" />
 </td>
 <td>
     <asp:Button ID="btnCancel" runat="server" Text="Cancel Selected Order" OnClick="btnCancel_Click" />
 </td>
 </tr>     
 ...
 <tr>
    ...
    <asp:Label CssClass="bodyText" ID="lblMsg" Text="The order was processed/Canceled successfully." runat="server"></asp:Label> 
    <br/>
    <br/>
    </td>
    </tr>
    ...
    <td width="440" align="left">&nbsp;<a href="OrdersNew.aspx" class="bodyText">Back to New Orders<br/>
    </a><br>
    </td>
    </tr>
    <tr>
    <td align="left" width="11" valign="top"><img src="../Images/LeftMenu/arrow_main.gif" width="15" height="15" hspace="2" alt=""/></td>
    <td width="410" align="left">&nbsp;<a href="OrdersProcessed.aspx" class="bodyText">Processed Orders</a><br/>
    <br>
    </td>
    </tr>
    <tr>
    ...
    <td width="440" align="left" style="height: 15px">&nbsp;<a href="OrdersCancelled.aspx" class="bodyText">Cancelled Orders</a>
    </td>
    </tr>
    </table>
    </td>
