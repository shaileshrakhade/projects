...
<title>Careear {GS} By Shailesh</title>
...
<div id="n-logo" style="margin-left:10px; margin-top:0px; ">
				...
				<h1 style="color: white; font-family: cursive; font-size: 25px">Career <span style="color: orange">{GS}</span></h1>
...
<input type="text" name="mob" placeholder="Mob" maxlength="10" minlength="10"><br>
<br>
<input type="submit" value="Submit">
</form>
<hr>
<a href="../index.jsp" style="color:black; font-size:20px;">Home</a><br>
<a href="Client_login.jsp" style="color:black; font-size:20px;">Client Login</a>
...
<div class="footer">
<h3>Site Devloped By Shailesh Rakhade</h3>
