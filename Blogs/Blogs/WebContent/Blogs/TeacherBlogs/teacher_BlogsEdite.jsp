    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" id="txtId"  name="post_id" style="width: 100%" required="required">
          <input type="hidden" value="2" name="txtusertype" style="width: 100%" required="required">
        </div>
        <div class="col-sm-12 ">       
...
if(Delid!=null)
{
	...
	if(i>0)
	{
		...
		{
			window.location = "../TeacherBlogs/teacher_BlogsEdite.jsp";
		}
		else
			{
			window.location = "../TeacherBlogs/teacher_BlogsEdite.jsp";
		...
		<%
		response.sendRedirect("../TeacherBlogs/teacher_BlogsEdite.jsp");
	}else
	{
		%>
		<script type="text/javascript">
